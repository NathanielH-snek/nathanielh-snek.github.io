...
export const skillData = [
  ...
  {
    id: 9,
    skill: <Icon icon="simple-icons:prefect" className="display-4" />,
    name: "Prefect",
  },
  {
    id: 10,
...
export const resume = "https://docs.google.com/document/d/e/2PACX-1vQk-1lVcbmX9XhbmPlDKBVz10482cDRVCoExesGuRYzIJrWWhm2xobEhHaMtXC-3qsq9vVNDmMWtOBA/pub";
...
export const filteredProjects = [
  "PresidentialSpeechAnalysis",
  "StackOverflowAISentiment",
  "SpotifyChartTracker",
  ...
  "Med2XLPy",
  "piGUI",
  "ParentalDegreeMonetaryOutcomes"
];
